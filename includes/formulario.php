...
<div class="wrap woocommerce">
  ...
  <form method="post" action="options.php">
    ...
    <table class="form-table apg-table">
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_nif_settings[requerido]">
        ...
        <td class="forminp"><input id="apg_nif_settings[requerido]" name="apg_nif_settings[requerido]" type="checkbox" value="1" <?php echo ( isset( $configuracion['requerido'] ) && $configuracion['requerido'] == "1" ? 'checked="checked"' : '' ); ?> tabindex="<?php echo $tab++; ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_nif_settings[requerido_envio]">
            <?php _e( 'Require shipping field?', 'apg_nif' ); ?>
          </label>
          <span class="woocommerce-help-tip" data-tip="<?php _e( "Check if you need to require the field", 'apg_nif' ); ?>"></span> </th>
        <td class="forminp"><input id="apg_nif_settings[requerido_envio]" name="apg_nif_settings[requerido_envio]" type="checkbox" value="1" <?php echo ( isset( $configuracion['requerido_envio'] ) && $configuracion['requerido_envio'] == "1" ? 'checked="checked"' : '' ); ?> tabindex="<?php echo $tab++; ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_nif_settings[validacion]">
        ...
        <td class="forminp"><input id="apg_nif_settings[validacion]" name="apg_nif_settings[validacion]" type="checkbox" value="1" <?php echo ( isset( $configuracion['validacion'] ) && $configuracion['validacion'] == "1" ? 'checked="checked"' : '' ); ?> tabindex="<?php echo $tab++; ?>" /></td>
      </tr>
    </table>
    <p class="submit">
